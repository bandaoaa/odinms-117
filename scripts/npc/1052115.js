    ...
    switch (selection) {
        case 0:
            ...
            if (!cm.start_PyramidSubway(-1)) {
                cm.getClient().sendPacket(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "堆積灰塵的月臺目前擁擠，請稍後再試"));
            }
            break;
        case 1:
            ...
            cm.getClient().sendPacket(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "999號列車月臺目前擁擠，請稍後再試"));
            cm.dispose();
            break;
        case 2:
