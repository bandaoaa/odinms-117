...
function start() {
    ...
    if (location == -1) {
        ...
        for (var i = 0; i < togosName[location].length; i++) {
            menu += "\r\n#L" + i + "#去往#m" + togosName[location][i] + "#。";
            if (i == 0 && cm.getMapId() == 230000000) {
                menu += "（玩具城/童话村方向）";  // 仅在230000000地图上添加说明
            }
            menu += "#l";
        }
        cm.sendSimple("世界上所有的海都是相通的。走着去很远的地方，通过大海很\r\n快就能到达。怎么样？你想乘坐#b海豚出租车吗#k？\r\n#b" + menu);
    }
}
