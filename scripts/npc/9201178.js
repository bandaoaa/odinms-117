...
function start() {
    ...
    if (cm.getPlayer().getPosition().x < 960 || cm.getPlayer().getPosition().x > 1160 || cm.getPlayer().getPosition().y != -193) {
    ...
    if (ch == '0') {
        ...
        Packages.server.quest.MapleQuest.getInstance(28775).forceStart(cm.getPlayer(), 0, null);
