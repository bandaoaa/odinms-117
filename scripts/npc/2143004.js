...
function action(mode, type, selection) {
    ...
    switch (status) {
        case 0:
            ...
            var chat = "#e<探險隊: 女皇的戰爭>#n\r\n\r\n未來世界，騎士團女皇希納斯開始對世界樹產生興趣，因此她想去尋找世界樹，女皇和她的騎士團長成功的找到了世界樹，但是他們掉進了黑魔法師事先設置好的陷阱，黑魔法師控制了女皇和她的騎士團長們，讓他們成為了自己的傀儡。\r\n";
            ...
            if (squadAvailability == 1) {
                ...
                if (type == 0) {
                    ...
                    if (memberType == 0) {
                        ...
                        chat += "\r\n#L1#查看隊員資訊";
                        chat += "\r\n" + (cm.getChannelServer().getMapleSquad("Cygnus").getMembers().contains(cm.getPlayer().getName()) ? "#L3#离开探險隊" : "#L2#登記探險隊") + "";
                    }
                }
                if (type == 1) {
                    chat += "\r\n#L4#調整隊員清單";
        ...
        case 1:
            if (selection == 0 || selection == 8) {
                if (cm.registerSquad("Cygnus", 5, "已經成為了<女皇的戰爭>探險隊隊長，如果你想嘗試本次探險，請重新與我對話申請登記探險，否則你將無法參與本次探險。")) {
                    cm.sendOk("你已經成為<女皇的戰爭>探險隊隊長，請在5分鐘內召集好探險隊隊員進行探險，否則將會自動註銷本次探險資格。");
