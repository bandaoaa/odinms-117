...
function start() {
    ...
    if (cm.getPlayer().getPosition().x < 700 || cm.getPlayer().getPosition().x > 900 || cm.getPlayer().getPosition().y != -673) {
    ...
    if (ch == '0') {
        ...
        Packages.server.quest.MapleQuest.getInstance(28778).forceStart(cm.getPlayer(), 0, null);
