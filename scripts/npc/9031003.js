...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "好吧，你想要从我装备制作达人#b埃珅#k这里得到点什么？\r\n";
        ...
        if (selection == 0) {
            status = -1;
            cm.sendNext("装备制作是用采矿提炼好的矿物或宝石，在巨大的熔炉里融化\r\n，制作成自己需要的防具或武器的技术。只要在我这里学会了\r\n装备制作技术，就可以制作出以前从未见过的武器和防具。");
            cm.dispose();
        } else if (selection == 1) {
...
*/
                ...
                if (cm.getPlayer().getProfessionLevel(92010000) > 0) {
                    ...
                    cm.sendOk("没学习采矿的人，是无法学习装备制作的。没有材料的话，就\r\n不可能坚持下去……你先到旁边的采矿大师#b诺布#k那里去学习采\r\n矿吧。");
                }
            }
            cm.dispose();
        } else if (selection == 2) {
