...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendOk("#eYou currently have(#r" + cm.getPlayer().getVote
        Points() + "#k) Vote Points."
    )
        ;
        cm.dispose();
    } else if (selection == 3) {
        ...
        cm.sendSimple("You currently have(#r" + cm.getPlayer().getVote
        Points() + "#k) Vote Points.#e" +
        ...
        cm.sendSimple("Alright, here are the options \r\n#bYou currently have:#k (#r" + cm.getPlayer().getVote
        Points() + "#k) #bVote Points.#e#d" +
        ...
        cm.sendSimple("Pick a #rGM Scroll#k! You currently have: (#r" + cm.getPlayer().getVote
        Points() + "#k) Vote Points. #e#d" +
    ...
    )
        {
            ...
            cm.sendOk("Nice! Here are your 2 #i4031545#! You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice! Here are your 4 #i4031545#! You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice! Here are your 6 #i4031545#! You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice! Here are your 8 #i4031545#! You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice! Here are your 10 #i4031545#! You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice! Here are your 2 #i5220020#! You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice! Here are your 5 #i5220020#! You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice! Here are your 8 #i5220020#! You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice! Here are your 11 #i5220020#! You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice! Here are your 14 #i5220020#! You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice job, here is your GM Scroll! You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice job, here are your Maple Leaves. You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice job, here are your 2 #i2049100#. You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice job, here are your 3 #2340000#. You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
    ...
    )
        {
            ...
            cm.sendOk("Nice job, here is your #i4032013#. You now have:(#r" + cm.getPlayer().getVote
            Points() + "#k) Vote Points."
        )
            ;
            cm.dispose();
