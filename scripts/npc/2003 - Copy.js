var status = 0;
var occupationName = ["Leprechaun #b(Does nothing)#k", "NX Addict", "Hacker", "The Transformers AutoBots", "Smega Whore"];
    ...
    if (status == 0) { // allow GMs unlimited changes if they don't know about !occ :o
        ...
        if (cm.getPlayer().getReborns() >= 10 && cm.getMeso() >= 100000000 || cm.getPlayer().isGM()) {
            ...
            if (cm.getPlayer().isDonator()) { // Donator
                occupationName = ["Sniper", "Leprechaun #b(Does nothing)#k", "NX Addict", "Hacker", "The Transformers AutoBots", "Smega Whore", "Terrorist"];
        ...
        if (cm.getPlayer().isDonator()) {
            if (selection == 0) {
                ...
                cm.sendSimple("#rOccupation : #eSmega Whore#n#k\r\n\r\n#bDescription: A #eSmega Whore#n Occupation allows players to Smega without using smegas via @smega! \r\n- Level 7 #eSmega Whore#n allows you to use @avi and more!#k\r\n#L6#I want to become a Smega Whore\r\n#L99#Go back");
            } else if (selection == 6) {
                cm.sendSimple("#rOccupation : #eTerrorist#n *Donator Exclusive*#k\r\n\r\n#bDescription: A #eTerrorist#n Occupation allows players to spawn bombs that will detonate and possibly bounce players away! \r\n- Level 4 #eTerrorist#n allows you to use @mug and more!#k\r\n#L7#I want to become a Terrorist\r\n#L99#Go back");
            }
        } else {
            if (selection == 0) {
