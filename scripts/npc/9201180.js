...
function start() {
    ...
    if (cm.getPlayer().getPosition().x < 860 || cm.getPlayer().getPosition().x > 1060 || cm.getPlayer().getPosition().y != 47) {
    ...
    if (ch == '0') {
        ...
        Packages.server.quest.MapleQuest.getInstance(28777).forceStart(cm.getPlayer(), 0, null);
