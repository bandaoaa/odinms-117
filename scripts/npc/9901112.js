...
function action(mode, type, selection) {
    if (mode == 1)
        ...
        cm.sendOk("#e#kI knew it..");
        cm.dispose();
        return;
    }
    if (status == 0) {
        cm.sendSimple("Hello! Do you want some rare and awesome items? It will require some materials, do you wanna do it? Although, make sure after gathering all of the required items, talk to Brandon in the far right of Henesys, and he will make the rare and awesome item(s) you want! So whaddya say? Do you wanna do this?\r\n#i1382068#\r\n#i1402062#\r\n#i1442078#\r\n#i1452071#\r\n#i1472086#\r\n#i1492037##e#d" +
            "\r\n#L1##kYes, I wanna do this!");
        ...
        if (cm.haveItem(4001126, 100)) {
            ...
            cm.sendOk("Nice job, here are your 1,000,000 mesos!");
            cm.dispose();
        } else {
            cm.sendOk("#e#rYou do not have enough #i4031545#!!")
            cm.dispose();
        ...
        cm.sendSimple("Pick any GM Scroll you want, but only if you got enough Maple Leaves!#e#d" +
        ...
        if (cm.haveItem(4001126, 2500)) {
            ...
            cm.gainItem(4001126, -2500);
            cm.sendOk("Nice job, here are your Crystal Illbi's!");
            cm.dispose();
        } else {
            cm.sendOk("#e#rYou do not have enough #i4001126#!!")
            cm.dispose();
