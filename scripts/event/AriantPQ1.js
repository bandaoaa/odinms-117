...
function playerEntry(eim, player) {
    ...
    player.getClient().sendPacket(CField.getClock((Long.parseLong(eim.getProperty("entryTimestamp")) - System.currentTimeMillis()) / 1000));
    player.getClient().sendPacket(CField.updateAriantScore(eim.getPlayers()));
}
