...
function enter(pi) {
    ...
    if (avail == null) {
        ...
        pi.getClient().sendPacket(MaplePacketCreator.serverNotice(6, "This door is closed."));
        return false;
    } else {
        pi.getPlayer().changeMap(target, targetPortal);
        pi.getClient().sendPacket(MaplePacketCreator.serverNotice(6, "RUN TO THE RIGHT FOR YOUR LIFE!!!"));
        return true;
    }
}