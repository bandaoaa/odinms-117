...
public enum MapleBuffStat implements Serializable, Buffstat {
    ...
    MAXMP(0x4000, 1),
    INVINCIBLE(0x8000, 1),
    DRRKNESS_SOCIALY(0x20000, 1),
    SOULARROW(0x10000, 1),
    VOYD_PRESSURE(256, 1),
    //POTIC_MEDITATION            (0x2000000000000000L, 3),
    WILL_OF_SWORD(1048576, 1),
    ROBURST_ARMOR(65536, 1),
    RESHUFFLE_SWITCH(131072, 1),
    KATALIZE(0x800000, 2),
    NOVA_WARRIER(8, 4),
    STACK_ACC(0x400, 2),
    STACK_WATK(0x40000, 2),
    STACK_MATK(0x80000, 2),
    //2 - debuff
    //4 - debuff
    //8 - debuff
