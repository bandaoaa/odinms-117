        ...
        if (ret.skill) { // hack because we can't get from the datafile...
            switch (sourceid) {
                ...
                case 4211003: // pickpocket
                    ...
                    break;
                case 33121005: // Stinkbomb I think that's the fix? xD
                    ret.statups.put(MapleBuffStat.EXPRATE, ret.info.get(MapleStatInfo.x));
                ...
                case 21111001: // Smart Knockback
                    ...
                    ret.statups.put(MapleBuffStat.WATK, ret.info.get(MapleStatInfo.x));
                    ret.statups.put(MapleBuffStat.WDEF, ret.info.get(MapleStatInfo.x));
                    ret.statups.put(MapleBuffStat.MDEF, ret.info.get(MapleStatInfo.x));
                    break;
                ...
                case 21111012://Maha Blessing
                    ret.statups.put(MapleBuffStat.WATK, ret.info.get(MapleStatInfo.x));
                    ret.statups.put(MapleBuffStat.MATK, ret.info.get(MapleStatInfo.x));
                    break;
                case 1211009:
                case 1111007:
                ...
                case 51121004:
                case 50001214:
                case 32111014: //why does nobody add BaM stance lols    
                    ret.statups.put(MapleBuffStat.STANCE, (int) ret.info.get(MapleStatInfo.prop));
                    break;
                ...
                case 33111004:
                    ret.statups.put(MapleBuffStat.BLIND, ret.info.get(MapleStatInfo.x));
                    ret.monsterStatus.put(MonsterStatus.ACC, ret.info.get(MapleStatInfo.y));
                    ret.monsterStatus.put(MonsterStatus.WDEF, ret.info.get(MapleStatInfo.y));
                    ret.monsterStatus.put(MonsterStatus.MDEF, ret.info.get(MapleStatInfo.y));
                    //ignoreMobDamR
                    break;
                ...
                case 27111005: //
                    ret.statups.put(MapleBuffStat.ENHANCED_WDEF, ret.info.get(MapleStatInfo.x));
                    ret.statups.put(MapleBuffStat.ENHANCED_MDEF, ret.info.get(MapleStatInfo.x));
                    break;

                case 27111006: //
                    ret.statups.put(MapleBuffStat.ENHANCED_WATK, ret.info.get(MapleStatInfo.emad));
                    break;

                case 27121006: //
                    ret.statups.put(MapleBuffStat.DRRKNESS_SOCIALY, ret.info.get(MapleStatInfo.x));
                    break;

                case 27100003: //
                    ret.statups.put(MapleBuffStat.BLESS_OF_DARKNESS, ret.info.get(MapleStatInfo.y));
                    break;
                //BLESS_OF_DARKNESS Y
                case 60001216: //
                    ret.statups.put(MapleBuffStat.RESHUFFLE_SWITCH, ret.info.get(MapleStatInfo.pddX));
                    ret.statups.put(MapleBuffStat.RESHUFFLE_SWITCH, ret.info.get(MapleStatInfo.mddX));
                    ret.statups.put(MapleBuffStat.RESHUFFLE_SWITCH, ret.info.get(MapleStatInfo.accX));
                    ret.statups.put(MapleBuffStat.RESHUFFLE_SWITCH, ret.info.get(MapleStatInfo.mhpR));
                    break;

                case 60001217: //
                    ret.statups.put(MapleBuffStat.RESHUFFLE_SWITCH, ret.info.get(MapleStatInfo.padX));
                    ret.statups.put(MapleBuffStat.RESHUFFLE_SWITCH, ret.info.get(MapleStatInfo.cr));
                    ret.statups.put(MapleBuffStat.RESHUFFLE_SWITCH, ret.info.get(MapleStatInfo.x));
                    break;

                case 61101002: //
                    ret.statups.put(MapleBuffStat.WILL_OF_SWORD, ret.info.get(MapleStatInfo.mpCon));
                    ret.statups.put(MapleBuffStat.WILL_OF_SWORD, ret.info.get(MapleStatInfo.bulletCount));
                    ret.statups.put(MapleBuffStat.WILL_OF_SWORD, ret.info.get(MapleStatInfo.damage));
                    ret.statups.put(MapleBuffStat.WILL_OF_SWORD, ret.info.get(MapleStatInfo.attackCount));
                    ret.statups.put(MapleBuffStat.WILL_OF_SWORD, ret.info.get(MapleStatInfo.cooltime));
                    break;

                case 61111003: //
                    ret.statups.put(MapleBuffStat.STATUS_RESIST, ret.info.get(MapleStatInfo.mpCon));
                    ret.statups.put(MapleBuffStat.STATUS_RESIST, ret.info.get(MapleStatInfo.time));
                    ret.statups.put(MapleBuffStat.STATUS_RESIST, ret.info.get(MapleStatInfo.asrR));
                    ret.statups.put(MapleBuffStat.STATUS_RESIST, ret.info.get(MapleStatInfo.terR));
                    ret.statups.put(MapleBuffStat.STATUS_RESIST, ret.info.get(MapleStatInfo.u));
                    ret.statups.put(MapleBuffStat.STATUS_RESIST, ret.info.get(MapleStatInfo.w));
                    ret.statups.put(MapleBuffStat.STATUS_RESIST, ret.info.get(MapleStatInfo.s));
                    break;

                case 61111004: //
                    ret.statups.put(MapleBuffStat.KATALIZE, ret.info.get(MapleStatInfo.mpCon));
                    ret.statups.put(MapleBuffStat.KATALIZE, ret.info.get(MapleStatInfo.time));
                    ret.statups.put(MapleBuffStat.KATALIZE, ret.info.get(MapleStatInfo.damage));
                    break;

                case 61121009: //
                    ret.statups.put(MapleBuffStat.ROBURST_ARMOR, ret.info.get(MapleStatInfo.mpCon));
                    ret.statups.put(MapleBuffStat.ROBURST_ARMOR, ret.info.get(MapleStatInfo.time));
                    ret.statups.put(MapleBuffStat.ROBURST_ARMOR, ret.info.get(MapleStatInfo.v));
                    ret.statups.put(MapleBuffStat.ROBURST_ARMOR, ret.info.get(MapleStatInfo.w));
                    break;

                case 61121014: //
                    ret.statups.put(MapleBuffStat.NOVA_WARRIER, ret.info.get(MapleStatInfo.mpCon));
                    ret.statups.put(MapleBuffStat.NOVA_WARRIER, ret.info.get(MapleStatInfo.time));
                    ret.statups.put(MapleBuffStat.NOVA_WARRIER, ret.info.get(MapleStatInfo.x));
                    break;

                case 65001002: //
                    ret.statups.put(MapleBuffStat.STACK_ACC, ret.info.get(MapleStatInfo.indieAcc));
                    ret.statups.put(MapleBuffStat.STACK_ACC, ret.info.get(MapleStatInfo.time));
                    break;

                case 65101002: //
                    ret.statups.put(MapleBuffStat.POWERGUARD, ret.info.get(MapleStatInfo.y));
                    ret.statups.put(MapleBuffStat.POWERGUARD, ret.info.get(MapleStatInfo.time));
                    ret.statups.put(MapleBuffStat.POWERGUARD, ret.info.get(MapleStatInfo.x));
                    break;

                case 65111003: //
                    ret.statups.put(MapleBuffStat.STACK_WATK, ret.info.get(MapleStatInfo.time));
                    ret.statups.put(MapleBuffStat.STACK_WATK, ret.info.get(MapleStatInfo.indiePad));
                    break;

                case 65111004: //
                    ret.statups.put(MapleBuffStat.STANCE, ret.info.get(MapleStatInfo.time));
                    ret.statups.put(MapleBuffStat.STANCE, ret.info.get(MapleStatInfo.prop));
                    break;

                case 27101202: //
                    ret.statups.put(MapleBuffStat.VOYD_PRESSURE, ret.info.get(MapleStatInfo.prop));
                    break;

                case 27111004: //
                    ret.statups.put(MapleBuffStat.STATUS_RESIST, ret.info.get(MapleStatInfo.terR));
                    ret.statups.put(MapleBuffStat.ELEMENT_RESIST, ret.info.get(MapleStatInfo.terR));
                    break;
                case 2301004:
                case 9001003:
                case 9101003:
                ...
                case 51111004:
                    ...
                    break;
                case 24111003://Bad Luck Ward PHANTOM ~Burblish
                    ret.statups.put(MapleBuffStat.MAXHP, ret.info.get(MapleStatInfo.x));
                    ret.statups.put(MapleBuffStat.MAXMP, ret.info.get(MapleStatInfo.x));
                    ret.statups.put(MapleBuffStat.STATUS_RESIST, ret.info.get(MapleStatInfo.x));
            ...
            if (GameConstants.isBeginnerJob(sourceid / 10000) || GameConstants.isMihile(sourceid)) {
    ...
    private void applyBuffEffect(final MapleCharacter applyfrom, final MapleCharacter applyto, final boolean primary, final int newDuration) {
        ...
        switch (sourceid) {
            ...
            case 24121004:
                ...
                localstatups.put(MapleBuffStat.WDEF, info.get(MapleStatInfo.x));
                localstatups.put(MapleBuffStat.MDEF, info.get(MapleStatInfo.x));
