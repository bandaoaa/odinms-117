...
public class MobHandler {
    ...
    public static void MoveMonster(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
    ...
    */
    public static void FriendlyDamage(final LittleEndianAccessor slea, final MapleCharacter chr) {
        ...
        if (mobfrom != null && mobto != null && mobto.getStats().isFriendly()) {
            final int damage = (mobto.getStats().getLevel() * Randomizer.nextInt(mobto.getStats().getLevel())) / 4; //傷害參數值
    ...
    */
    public static void MonsterBomb(final int oid, final MapleCharacter chr) {
        ...
        if (selfd != -1) {
            monster.getMap().broadcastMessage(MobPacket.killMonster(monster.getObjectId(), 2));
...
//	slea.skip(4); // Some type of pos, damage display, I think
    ...
    public static void RenameFamiliar(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
    ...
    public static void SpawnFamiliar(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        slea.readInt();
    ...
    public static void MoveFamiliar(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
    ...
    public static void AttackFamiliar(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
    ...
    public static void TouchFamiliar(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        ...
        if (!target.getStats().isFriendly()) { //approx.
    ...
    public static void UseFamiliar(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
