...
public class HairAndEyeCreator {
    public static void main(String args[]) throws IOException {
        ...
        FileOutputStream out = new FileOutputStream("hairAndFacesID.txt", false);
        ...
        System.out.println("Finished loading Male Hairs!");
        ...
        System.out.println("Finished loading Female Hairs!");
        ...
        System.out.println("Finished loading Male Faces!");
