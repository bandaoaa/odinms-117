...
public class CField {
    ...
    public static byte[] spawnPlayerMapobject(MapleCharacter chr) {
        ...
        if (chr.getBuffedValue(MapleBuffStat.SOARING) != null) {
            ...
            buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.SOARING).intValue()), Integer.valueOf(2)));
            buffvalue.add(new Pair(Integer.valueOf(chr.getTrueBuffSource(MapleBuffStat.SOARING)), Integer.valueOf(3)));
        }
    ...
    public static byte[] facialExpression2(int expression, int duration) { //Credits to AristoCat
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
...
//        }
    ...
    public static class UIPacket {
        ...
        public static byte[] DublStartAutoMove() {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.TUTORIAL_AUTOMOVE.getValue());
            mplew.write(3);
            mplew.writeInt(2);
            return mplew.getPacket();
        }
    ...
    /*
public static byte[] giveMorphGage(short gages) {
    MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    short gages1 = gages;
    mplew.writeShort(SendPacketOpcode.GIVE_BUFF.getValue());
    mplew.writeInt(0);
    mplew.writeShort(32768);
    mplew.write0(30);
    mplew.writeShort(gages1);

    mplew.writeInt(0);
    mplew.write(HexTool.getByteArrayFromHexString("FE 7B B6 BF"));
    mplew.write0(10);
    return mplew.getPacket();
  }
public static byte[] showOwnAngelicBlessEffect(int skillid) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.SHOW_ITEM_GAIN_INCHAT.getValue());
        mplew.write(2);
        mplew.writeInt(skillid);
    ...
    public static byte[] showAngelicBlessEffect(int cid, int skillid) { //Angelic
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.SHOW_FOREIGN_EFFECT.getValue());
        mplew.writeInt(cid);
        mplew.write(2);
    ...
    public static Packet absorbingDF(int oid, int room, int amount) {//Demon Slayer
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        mplew.writeInt(room);
        mplew.writeInt(amount);
        mplew.writeInt(Randomizer.rand(35, 45));
        mplew.writeInt(Randomizer.rand(4, 6));
        mplew.writeInt(Randomizer.rand(35, 45));
        mplew.write(0);
        return mplew.getPacket();
    }
