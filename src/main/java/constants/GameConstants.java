...
public class GameConstants {
    ...
    public static boolean isMihile(final int job) {     //Buster
 ...
 public static boolean isKaiser1(int job) {//Kaiser
 return ((job == 6100) || (job == 6110));
 }
 public static boolean isKaiser2(int job) {//Kaiser
    ...
    public static int getLinkedAranSkill(final int id) {
        switch (id) {
            ...
            case 24121010:
                return 24121003;
            case 24111006:
                return 24111008; //Guessed? Rapier Wit
            //case 61001003:
            //case 61001004:
            //case 61001005:
            // return 61001000;
